...
- [x] JS文件API接口路径
- [x] JS文件URL
- [x] 特殊字段(password、method: "post"...)https://github.com/ScriptKid-Beta/Unexpected_information/blob/9e606f8ce080ea7d29349fdab161701a37468ee9/src/main/java/burp/Re.java#L57
- [x] JSON Web Token
